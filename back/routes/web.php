...
Route::get('/home', [App\Http\Controllers\HomeController::class, 'index'])->name('home')->middleware('isadmin', 'auth');

//R del CRUD
Route::get('/',[ItemController::class,'index'])->name('home')->middleware('isadmin', 'auth');
Route::get('/home',[ItemController::class,'index'])->middleware('isadmin', 'auth');
...
//S Show
Route::get('/home', [HomeController::class, 'index'])->name('home')->middleware('isadmin', 'auth');
Route::get('/show/{id}',[ItemController::class,'show'])->name('showItem')->middleware('isadmin', 'auth');
//C del CRUD
