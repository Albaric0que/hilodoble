...
//U del user
/* Route::get('/usersList/{id}', [UserController::class, 'edit'])->name('updateUser')->middleware('isadmin', 'auth');
 */
Route::patch('/usersList/{id}', [UserController::class, 'update'])->name('updateUser')->middleware('isadmin', 'auth');
